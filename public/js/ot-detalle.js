...
const WA_SVG = `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M16.5 8.8a6 6 0 0 0-8.7 8.1l-.8 2.9 3-.8a6 6 0 0 0 6.5-10.2z"/><path d="M9.5 10.5s.5 1 1 1.5 1.5 1 1.5 1"/></svg>`;
